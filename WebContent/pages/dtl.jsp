...
<html>
   <head>
      ...
      <script type="text/javascript" async="" src="/HouseSearcher/pages/dtl_files/analytics.js"></script>
      ...
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/common.css">
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/header.css">
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/weiliao.css">
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/detail.css">
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/detail_top.css">
      <!--[if lt IE 9]>
      <script type="text/javascript" src="http://sh.lianjia.com/public/js/html5.js"></script>
      <![endif]-->
      <script type="text/javascript" async="" src="/HouseSearcher/pages/dtl_files/vds.js"></script><script async="" src="/HouseSearcher/pages/dtl_files/gtm.js"></script><script async="" src="/HouseSearcher/pages/dtl_files/analytics.js(1)"></script><script>
      ...
      <script src="/HouseSearcher/pages/dtl_files/jquery.min.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jQuery.XDomainRequest.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jquery.qrcode.min.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jquery-upload-1.0.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jquery-jtemplates.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jquery.cookie.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/common.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/compare.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/saveSearchInit.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/ljubt.min.js"></script><script src="/HouseSearcher/pages/dtl_files/lianjiaUlog.js"></script>
            ...
            <div class="album-box">
               <div class="album-box left" id="album-box">
                  <div class="pic-panel pic-panel-hover" style="overflow:hidden;">
                     <a href="javascript:;">
                     <img src="/HouseSearcher/pages/dtl_files/0d276395-a616-42c3-b96f-45deaf65dd29.jpg_600x450.jpg" id="view_big_img" onerror="this.src=&#39;http://cdn7.dooioo.com/static/img/new-version/default_block.png&#39;; this.onerror=null;">
                     </a>
                     <div class="label">
                     ...
                     <div id="map-around" class="map-content" xiaoqu="海天公寓" style="overflow: hidden; position: relative; z-index: 0; background-color: rgb(243, 241, 236); color: rgb(0, 0, 0); text-align: left;">
                        <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: url(&quot;http://api0.map.bdimg.com/images/openhand.cur&quot;) 8 8, default;">
                           ...
                           <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;">
                              ...
                              <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;">
                                 <span class="BMap_Marker" unselectable="on" style="position: absolute; padding: 0px; margin: 0px; border: 0px; width: 0px; height: 0px; left: 319px; top: 99px; z-index: -6239530;">
                                    <div style="position: absolute; margin: 0px; padding: 0px; width: 27px; height: 41px; overflow: hidden;"><img src="/HouseSearcher/pages/dtl_files/point-dis-around.png" style="display: block; border:none;margin-left:0px; margin-top:0px; "></div>
                                 </span>
                                 <span class="BMap_Marker" unselectable="on" style="position: absolute; padding: 0px; margin: 0px; border: 0px; width: 0px; height: 0px; left: 327px; top: 272px; z-index: -6238998;">
                                    <div style="position: absolute; margin: 0px; padding: 0px; width: 27px; height: 41px; overflow: hidden;"><img src="/HouseSearcher/pages/dtl_files/aroundPos.png" style="display: block; border:none;margin-left:2px; margin-top:0px; "></div>
                           ...
                           <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;">
                              <div style="position: absolute; overflow: visible; z-index: -100; left: 335px; top: 165px; display: block; transform: translate3d(0px, 0px, 0px);"><img src="/HouseSearcher/pages/dtl_files/saved_resource" style="position: absolute; border: none; width: 256px; height: 256px; left: -174px; top: -103px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(1)" style="position: absolute; border: none; width: 256px; height: 256px; left: -430px; top: -103px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(2)" style="position: absolute; border: none; width: 256px; height: 256px; left: 82px; top: -103px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(3)" style="position: absolute; border: none; width: 256px; height: 256px; left: -174px; top: 153px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(4)" style="position: absolute; border: none; width: 256px; height: 256px; left: -174px; top: -359px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(5)" style="position: absolute; border: none; width: 256px; height: 256px; left: -430px; top: 153px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(6)" style="position: absolute; border: none; width: 256px; height: 256px; left: -430px; top: -359px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(7)" style="position: absolute; border: none; width: 256px; height: 256px; left: 82px; top: 153px; max-width: none; opacity: 1;"><img src="/HouseSearcher/pages/dtl_files/saved_resource(8)" style="position: absolute; border: none; width: 256px; height: 256px; left: 82px; top: -359px; max-width: none; opacity: 1;"></div>
                           </div>
                        ...
                        <div unselectable="on" class=" BMap_scaleCtrl BMap_noprint anchorTL" style="bottom: auto; right: auto; top: 18px; left: 81px; width: 62px; position: absolute; z-index: 10; text-size-adjust: none;">
                           ...
                           <div class="BMap_scaleBar BMap_scaleHBar" style="background-color: black;"><img style="border:none" src="/HouseSearcher/pages/dtl_files/mapctrls.png"></div>
                           <div class="BMap_scaleBar BMap_scaleLBar" style="background-color: black;"><img style="border:none" src="/HouseSearcher/pages/dtl_files/mapctrls.png"></div>
                           <div class="BMap_scaleBar BMap_scaleRBar" style="background-color: black;"><img style="border:none" src="/HouseSearcher/pages/dtl_files/mapctrls.png"></div>
                        </div>
...
<div id="compare-houses" style="position:fixed; top:40%; right:0px; min-width:250px; visibility:hidden;">
   ...
   <div style="background-color:#e4e3e3; width:100%; text-align:center; padding-top:5px; padding-bottom:5px;">
      ...
      <!-- 微聊  end-->
      <script src="/HouseSearcher/pages/dtl_files/loginpoplayer.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/jquery.lazyload.min.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/passport.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/suggestion.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/search.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/AV.realtime.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/angular.min.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/weiliao.min.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/bundle.js"></script><iframe src="/HouseSearcher/pages/dtl_files/ns.html" height="0" width="0" style="display:none;visibility:hidden"></iframe>
      <script src="/HouseSearcher/pages/dtl_files/user.js"></script>
      <link rel="stylesheet" href="/HouseSearcher/pages/dtl_files/style.css">
      <script type="text/javascript" src="/HouseSearcher/pages/dtl_files/api"></script><script type="text/javascript" src="/HouseSearcher/pages/dtl_files/getscript"></script>
      <script src="/HouseSearcher/pages/dtl_files/zoom-viewer.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/zufang_detail.js"></script>
      <script src="/HouseSearcher/pages/dtl_files/around.js"></script>
   </body>
</html>
