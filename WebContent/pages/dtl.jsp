...
<html>
   <head>
      ...
      <script type="text/javascript" src="/HouseSearcher/js/Compare.js"></script>
   ...
   <body>
      ...
      <!--begin:正文-->
      <!--begin: 房源概况-->
      <div style="margin-top: 20px; padding-top: 20px;" class="zf-top">
    ...
    <div style="cursor: pointer; cursor: hand;background-color:#a0a0a0; color:#ffffff; text-align:center; width:100%; padding-top:5px; padding-bottom:5px;"><span>&lt;<br/>展<br/>开</span></div>
    <div style="cursor: pointer; cursor: hand;background-color:#e4e3e3; text-align:center; padding-top:5px; padding-bottom:5px;"><span>住<br/>房<br/>比<br/>较</span></div>
 </div>
 <div id="compare-houses" style="position:fixed; top:40%; right:0px; min-width:250px; visibility:hidden;">
    ...
    <div style="background-color:#e4e3e3; width:100%; text-align:center; padding-top:5px; padding-bottom:5px;">
		...
		<a id="begin-compare-houses" style="display:inline-block; background-color:red; width:80px; padding: 5px 5px 5px 5px; color:#FFFFFF;" target="_blank" href="/HouseSearcher/pages/compare-houses.jsp" >比较</a>&nbsp;&nbsp;&nbsp;
